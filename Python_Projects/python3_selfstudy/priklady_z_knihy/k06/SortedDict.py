...
"""Slovník, který má je seřazen podle operátoru < aplikovaného na klíče nebo 
na výsledek klíčové funkce aplikované na klíče

Toto jsou testy pro zděděné metody, které nejsou implementovány
...
class SortedDict(dict):
    ...
    def fromkeys(cls, iterable, value=None, key=None):
        """Metoda třídy, která vrací objekt typu SortedDict,
        jehož klíče jsou z iterovatelného objektu a každá hodnota
        je zadanou hodnotou
    ...
    def value_at(self, index):
        """Vrátí hodnotu prvku na pozici zadané indexem
    ...
    def set_value_at(self, index, value):
        """Nastaví hodnotu prvku na pozici zadané indexem na zadanou hodnotu
    ...
    def clear(self):
        """Odstraní všechny prvky z tohoto objektu typu SortedDict
        >>> d = SortedDict(dict(s=1, a=2, n=3, i=4, t=5, y=6))
        >>> len(d)
        6
        >>> d.clear()
    ...
    def setdefault(self, key, value=None):
        """Je-li klíč ve slovníku, vrátí jeho hodnotu,
        jinak přidá klíč se zadanou hodnotou, kteoru také vrátí
    ...
    def pop(self, key, *args):
        """Je-li klíč ve slovníku, vrátí jeho hodnotu a odstraní jej
        ze slovníku. V opačném případě vrátí arg, je-li zadán nebo 
    ...
    def popitem(self):
        """Vrátí a odstraní libovolná prvek ze slovníku
    ...
    def values(self):
        """Vrátí hodnoty slovníku seřazené podle klíčů
    ...
    def items(self):
        """Vrátí prvky slovníku seřazené podle klíčů
    ...
    def __iter__(self):
        """Vrátí iterátor přes klíče slovníku
    ...
    def __delitem__(self, key):
        """Vymaže prvek se zadaným klíče ze slovníku
    ...
    def __setitem__(self, key, value):
        """Je-li klíč ve slovníku, nastaví jeho hodnotu na zadanou hodnotu,
        jinak přidá klíč se zadanou hodnotou do slovníku 
    ...
    def copy(self):
        """Vrátí mělkou kopii slovníku se stejnou klíčovou funkcí
