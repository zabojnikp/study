...
def conjunction(*fuzzies):
    """Vrátí logickou konjunkci všech objektů typu FuzzyBool
...
def disjunction(*fuzzies):
    """Vrátí logickou disjunkci všech objektů typu FuzzyBool
...
class FuzzyBool(float):
    ...
    def __invert__(self):
        """Vrátí logickou negaci tohoto objektu typu FuzzyBool
    ...
    def __and__(self, other):
        """Vrátí logickou konjunkci tohoto a druhého objektu typu FuzzyBool
    ...
    def __iand__(self, other):
        """Aplikuje logickou konjunkci na tento objekt typu FuzzyBool s druhým
    ...
    def __or__(self, other):
        """Vrátí logickou disjunkci tohoto a druhého objektu typu FuzzyBool
    ...
    def __ior__(self, other):
        """Aplikuje logickou disjunkci na tento objekt typu FuzzyBool s druhým
