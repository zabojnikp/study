...
class Image:
    ...
    def resize(self, width=None, height=None):
        """Změní velikost na zadané rozměny a vrátí True, pokud se změny provedou

        Má-li některý rozměr hodnotu None, ponechá se původní. Všechny body
        mimo nové hranice se vymažou.
